 ...
 * when the ban-menh screen lands as its own change.
 */
export default function Page() {
  return (
    <ScreenPad>
      <StickyHeader eyebrow="Chào buổi tối" title="Bản mệnh" subtitle="Lá Bài Bản Mệnh ở đầu — vuốt sang để lật 3 lá bài phụ." />
