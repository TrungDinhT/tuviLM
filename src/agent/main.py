...
- Trước khi luận sao chi tiết, gọi get_list_cach_cuc để lấy cách cục match. Tra nghĩa cách cục qua read_section, ưu tiên cách cục có priority cao hơn làm khung luận chính.
