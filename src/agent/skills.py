...
4. Cần tìm kiếm thông tin của : chính tinh, phụ tinh, tuần/triệt, tứ hóa, trạng sinh của cung trọng tâm, xung chiếu, tam hợp. Tra nghĩa sao trong sách bằng read_catalog rồi read_section. Ưu tiên đọc chính tinh trước, rồi mới tới phụ tinh/tuần triệt/tứ hóa/tràng sinh.
...
1. read_catalog(section_id=None, depth=3)
   ...
   - depth quyết định nhìn sâu bao nhiêu tầng; bắt đầu với depth=2, tăng lên 3-4 nếu cần dò sâu hơn.
   - Kết quả trả về id và title của từng mục; dùng id đó cho read_section.
...
2. read_section(section_id, max_chars=8000)
   ...
   - Nếu id có hậu tố slug như "8.11#bo-sao-khoc-hu-thien-khoc-thien-hu", tool sẽ đọc "8.11".
...
## Note
- Nên bắt đầu bằng read_catalog(None, depth=1) để xem các phần sách chính, sau đó đi sâu dần vào các mục con.
